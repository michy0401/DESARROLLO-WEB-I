...
function confirmacion(){
    ...
    /*par aimrpimir una variable en una cadena podemos utilizar las comillas simples
...
function dibujarParrafo(){
    ...
    /*Utilizaremos la API DOM para acceder al elemento <p id="idParrafo"></p> que hemos creado en uestro documento html */
