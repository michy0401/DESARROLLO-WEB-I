//Accedamos al contenedor donde se mostrara los estudiantes
const containerEstudiantes = document.querySelector("#idContainerEstudiantes");

//Accedemos a cada boton por medio de la API DOM
const btnPromedio = document.querySelector("#idBtnPromedio");

//Agregamos el evento click a los botones, adicionalmente se le asgina la funcion que realiara la operacion
...
function generarEstudiantes(){
    ...
    //Recorriendo el arreglo con for..of verificamos cual es el promedio de las calificaciones y cual de los estudiantes posee la calificacion mas alta
