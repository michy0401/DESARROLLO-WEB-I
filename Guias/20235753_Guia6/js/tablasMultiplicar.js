...
//Agregamor el evento click al boton calcular se le asigna la funcion que realizara la operacion 
btnCalcular.addEventListener("click", calcularTabla);

function calcularTabla(){
    //capturamos el calor del campo
    ...
    if (inputTabla > 0) {
        ...
        alert("No se ha ingresad un numero valido")
    }
}